...
d2 = 6.375;
disp("Please enter the Cartesian point:");
Trans = input('');
...
%     num = -sind(theta_1(i))*Trans(1,3) + cosd(theta_1(i))*Trans(2,3);
    ...
    %denominator
%     den = (cosd(theta_1(i))*sind(theta_2(i))*Trans(1,3) + sind(theta_1(i))*sind(theta_2(i))*Trans(2,3) + cosd(theta_2(i))*Trans(3,3))*sind(theta_4(i));
...
disp('\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\');
for i = 1:8
    Inverse_Outout(theta_1(i), theta_2(i), d3(i), theta_4(i), theta_5(i), theta_6(i));
end